...
class Regen(Effect):
    ...
    def copy(self):
        return Regen(self.name, self.description, self.duration, self.element, self.can_stack, self.coeffs, self.user)
...
class Buff(Effect):
    ...
    def copy(self):
        return Buff(self.name, self.description, self.duration, self.element, self.can_stack, self.coeffs, self.user)